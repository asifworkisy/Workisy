  ...
  return (
    <div className="filter-dropdown" ref={dropdownRef} role="region" aria-labelledby={`${title}-label`}>
      ...
      <button
        ...
        id={`${title}-label`}
        style={{
          backgroundColor: selectedOptions.length > 0 ? '#2557a7' : 'transparent', // Apply background color if options are selected
          color: selectedOptions.length > 0 ? 'white' : 'black', // Change text color for contrast
        }}
      >
        <span>
          {title}
